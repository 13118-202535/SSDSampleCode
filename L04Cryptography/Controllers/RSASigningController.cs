...
namespace L04Cryptography.Controllers
{
    public class RSASigningController : Controller
    {
        public IActionResult SignAndVerify()
        {
            ...
            //compute the hash of the data and sign with RSA private key
            byte[] senderSignature = rsa.SignData(msg, HashAlgorithmName.SHA512, RSASignaturePadding.Pkcs1);
            string b64Signature = Convert.ToBase64String(senderSignature);
            ...
            //verify the senderSignature
            bool result = rRSA.VerifyData(msg, senderSignature, HashAlgorithmName.SHA512, RSASignaturePadding.Pkcs1);
